...
No inventes cantidades exactas."
        ...
        return await _llm.CreateChatCompletionAsync(_opt.ModelWriter, msgs, jsonMode: false, maxTokens: _opt.WriterMaxTokens, temperature: 0.35, ct: ct);
    }
...
No inventes datos."
        ...
        return await _llm.CreateChatCompletionAsync(_opt.ModelWriter, msgs, jsonMode: false, maxTokens: _opt.WriterMaxTokens, temperature: 0.2, ct: ct);
    }
}
